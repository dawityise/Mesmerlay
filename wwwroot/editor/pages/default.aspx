<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="editor_pages_default" %>
...
<body>
            ...
            <div id="wanaYizet" style="width:720px;">
    ...
    <div style="width:710px;">
        <div style="width: 590px; height: 400px; float:left;">
            <form method="get" action="../../fb/status.aspx">
            ...
            <script src="../js/fbconfig.js" type="text/javascript" language="javascript"></script>
            ...
            <div style="height:60px; padding:10px 0px; width:455px;">
            <input style="height:40px; font-weight:bold; color:White; background-color:#3b5998" type="submit" value="ሁኔታዬን በፌስቡኬ አስፍር" />
            </div>
            </form>
        </div>
    ...
    <div style="width:505px; float:left; height: 250px; background:#f8f8f8; border-style:solid; border-color:#cccccc; border-bottom-width:15px;
     ...
     <div style="float:left; border-top-width:10px; border-right-width:10px; 
         ...
         height:262px;">
     <h3 style="margin-left:25px; margin-right:25px;">ምሣሌዎች</h3>    
    <table style="margin-left:25px; margin-right:25px;" cellpadding="4px">
        <tr align="left">
