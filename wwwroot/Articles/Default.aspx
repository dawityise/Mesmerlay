<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Articles_Default" %>
...
<body>
    ...
    <div>
        ...
        <div id="yizet">
            ...
            <div id="wanaYizet">
                <h2 class="arstezena">መጣጥፎች</h2>
                <div id="ArticleTitle" runat="server"></div>                
